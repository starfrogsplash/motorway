...
export async function up(knex: Knex): Promise<void> {
    ...
    INSERT INTO "stateLogs" ("vehicleId", state, timestamp) VALUES (4, 'quoted',  '2022-09-10 10:23:54+00');
    INSERT INTO "stateLogs" ("vehicleId", state, timestamp) VALUES (5, 'quoted',  '2022-09-10 14:59:01+00');
    INSERT INTO "stateLogs" ("vehicleId", state, timestamp) VALUES (5, 'selling', '2022-09-11 17:03:17+00');
    INSERT INTO "stateLogs" ("vehicleId", state, timestamp) VALUES (6, 'quoted',  '2022-09-11 09:11:45+00');
    INSERT INTO "stateLogs" ("vehicleId", state, timestamp) VALUES (6, 'selling', '2022-09-11 23:21:38+00');
    INSERT INTO "stateLogs" ("vehicleId", state, timestamp) VALUES (6, 'sold',    '2022-09-12 12:41:41+00');
...
export async function down(knex: Knex): Promise<void> {
    await knex.schema.dropTable('vehicles').dropTable('StateLogs')
}
